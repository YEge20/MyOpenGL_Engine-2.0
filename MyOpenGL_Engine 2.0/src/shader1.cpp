...
Shader1::Shader1(const std::string& pathfile)
	:m_shaderID(0)
{
	ShaderFileType1 src = GetShaderFile(pathfile);
	m_filepath << pathfile;
	std::cout << "=========================================================================" << std::endl;
...
void Shader1::setuniformMat4f(const std::string& name, const glm::mat4& maritx)
{
	glUniformMatrix4fv(setuniformname(name), 1, GL_FALSE, &maritx[0][0]);
}

void Shader1::setuniform1i(const std::string& name, const int i1)
{
	glUniform1i(setuniformname(name), i1);
}

void Shader1::setuniform1iv(const std::string& name, const int count, int* array)
{
	glUniform1iv(setuniformname(name), count, array);
}

void Shader1::setuniform1f(const std::string& name, const float f1)
{
	glUniform1f(setuniformname(name), f1);
}

void Shader1::setuniformVEC2(const std::string& name, const float f1, const float f2)
{
	glUniform2f(setuniformname(name), f1, f2);
}

void Shader1::setuniformVEC3(const std::string& name, const float f1, const float f2, const float f3)
{
	glUniform3f(setuniformname(name), f1, f2, f3);
}

void Shader1::setuniformVEC4(const std::string& name, const float f1, const float f2, const float f3, const float f4)
{
	glUniform4f(setuniformname(name), f1, f2, f3, f4);
}

ShaderFileType1 Shader1::GetShaderFile(const std::string& pathfile)
{
	std::string line;
...
unsigned int Shader1::CreatShader(unsigned int type, const std::string& shaderfile)
{
...
unsigned int Shader1::CreatShaderProgram(const std::string& vertex, const std::string& fragment)
{
...
int Shader1::setuniformname(const std::string& name)
{
