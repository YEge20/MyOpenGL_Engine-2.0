	...
	m_grass_move(0.0f,-120.0f,0.0f),m_red(0),m_grass_2_move(0.0f,-112.0f,0.0f)
{
	...
	m_shader.reset(new Shader(false, "./shader/Grassground/BasicShader3D(Light_version)2.shader"));
	m_shader_1.reset(new Shader(false, "./shader/Grassground/GrassGround.shader"));
	m_shader_2.reset(new Shader(false, "./shader/Grassground/Grass.shader"));
