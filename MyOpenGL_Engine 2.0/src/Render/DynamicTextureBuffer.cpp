	...
	m_block_rotation(0)
{
	...
	m_shader_block.reset(new Shader(false,"./shader/DynamicTextureTest/BasicShader3D(color_version).shader"));
	...
	m_shader_blue_block.reset(new Shader(false,"./shader/DynamicTextureTest/BasicShader3D_blueblock.shader"));

	m_block_Dynamic.reset(new DrawBlock(120.0f, 80.0f, 0.0f));
	m_shader_DynamicTest.reset(new Shader(false,"./shader/DynamicTextureTest/2nd_BasicShader3D(color_version).shader"));
