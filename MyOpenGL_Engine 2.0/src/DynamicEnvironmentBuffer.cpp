...
void main()
{
	...
	{
		m_test_shader.reset(new Shader(false, ""));
...
glm::mat4 DynamicEnvironmentBuffer::Caculate_Camera(glm::vec3 Cam_Pos, glm::vec3 Cam_Fro)
{
	...
	if (glm::normalize(lookat) == glm::vec3(0.0f, 1.0f, 0.0f))
		lookat = lookat + glm::vec3(0.0f, 0.0f, 0.1f);
	else if (glm::normalize(lookat) == glm::vec3(0.0f, -1.0f, 0.0f))
		lookat = lookat + glm::vec3(0.0f, 0.0f, 0.1f);
